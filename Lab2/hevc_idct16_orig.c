...
{
  int E[8][8] __attribute__((aligned(16)));
  int O[8][8] __attribute__((aligned(16)));
  int EE[8][4] __attribute__((aligned(16)));
  int EO[8][4] __attribute__((aligned(16)));
  int EEE[8][2] __attribute__((aligned(16)));
  int EEO[8][2] __attribute__((aligned(16)));
  int add = 1<<(shift1-1);
